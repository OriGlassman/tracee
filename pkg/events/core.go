...
var CoreEvents = map[ID]Definition{
	...
	SocketDup: {
		...
		dependencies: Dependencies{
			probes: []Probe{
				{handle: probes.SocketDupBasedDupX86, required: false},
				{handle: probes.SockeDupBasedDup2X86, required: false},
				{handle: probes.SockeDupBasedDup3X86, required: false},
				{handle: probes.SocketDupBasedDupCompatX86, required: false},
				{handle: probes.SockeDupBasedDup2CompatX86, required: false},
				{handle: probes.SockeDupBasedDup3CompatX86, required: false},
				{handle: probes.SocketDupBasedDupARM, required: false},
				{handle: probes.SocketDupBasedDup2ARM, required: false},
				{handle: probes.SocketDupBasedDup3ARM, required: false},
				{handle: probes.SocketDupBasedDupCompatARM, required: false},
				{handle: probes.SocketDupBasedDup2CompatARM, required: false},
				{handle: probes.SocketDupBasedDup3CompatARM, required: false},
			},
		},
		sets: []string{},
		params: []trace.ArgMeta{
