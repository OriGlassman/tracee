...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		SocketDupBasedDupX86:        NewTraceProbe(KretProbe, "__x64_sys_dup", "trace_dup_ret"),
		SockeDupBasedDup2X86:        NewTraceProbe(KProbe, "__x64_sys_dup2", "trace_dup_2_3"),
		SockeDupBasedDup3X86:        NewTraceProbe(KProbe, "__x64_sys_dup3", "trace_dup_2_3"),
		SocketDupBasedDupCompatX86:  NewTraceProbe(KretProbe, "__ia32_compat_sys_dup", "trace_dup_ret"),
		SockeDupBasedDup2CompatX86:  NewTraceProbe(KProbe, "__ia32_compat_sys_dup2", "trace_dup_2_3"),
		SockeDupBasedDup3CompatX86:  NewTraceProbe(KProbe, "__ia32_compat_sys_dup3", "trace_dup_2_3"),
		SocketDupBasedDupARM:        NewTraceProbe(KretProbe, "__arm64_sys_dup", "trace_dup_ret"),
		SocketDupBasedDup2ARM:       NewTraceProbe(KProbe, "__arm64_sys_dup2", "trace_dup_2_3"),
		SocketDupBasedDup3ARM:       NewTraceProbe(KProbe, "__arm64_sys_dup3", "trace_dup_2_3"),
		SocketDupBasedDupCompatARM:  NewTraceProbe(KretProbe, "__arm64_compat_sys_dup", "trace_dup_ret"),
		SocketDupBasedDup2CompatARM: NewTraceProbe(KProbe, "__arm64_compat_sys_dup2", "trace_dup_2_3"),
		SocketDupBasedDup3CompatARM: NewTraceProbe(KProbe, "__arm64_compat_sys_dup3", "trace_dup_2_3"),
